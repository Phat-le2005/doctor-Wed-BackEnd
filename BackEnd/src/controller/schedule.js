...
const get_schedule = async (req, res) => {
  ...
  const handleGetAllScheduleDoctor = async (req,res) => {
    try {
      const { doctorId} = req.query; // 👈 lấy từ query string
      ...
      const data = await scheduleService.getAllScheduleDoctor(doctorId);
...
module.exports = {
    ...
    handleGetAllScheduleDoctor: handleGetAllScheduleDoctor
}